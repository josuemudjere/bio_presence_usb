...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setLocation('/admin/tableau-de-bord');
    } catch (error) {
      ...
      >
        ...
        >
          ...
          <CardHeader className="border-b border-white/10 pb-5">
            <CardTitle className="text-center text-2xl font-bold text-white">Connexion administrateur</CardTitle>
            <p className="mt-2 text-center text-sm text-slate-300">
              Connectez-vous pour accéder à la gestion complète des étudiants et des présences biométriques.
            </p>
          </CardHeader>
