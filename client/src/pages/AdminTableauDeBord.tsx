...
import { Users, Fingerprint, Clock, FileSpreadsheet, ArrowRight, CalendarDays } from 'lucide-react';
      ...
      <main className="ml-64 min-h-screen flex-1 bg-slate-50">
        ...
        <header className="sticky top-0 z-40 flex h-[73px] items-center justify-between border-b border-slate-200 bg-white px-8">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Tableau de bord administrateur</p>
          </div>
